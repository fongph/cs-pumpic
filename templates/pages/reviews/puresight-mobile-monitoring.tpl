...
{include file='../../includes/main/main-header.tpl'
    robots="yes" 
    title="PureSight parental control software review"
    description="Read editor's reviews, view a features comparison table, and learn more about PureSight mobile monitoring solution."
}    
