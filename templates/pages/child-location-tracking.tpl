	...
	{include file='../includes/main/main-top-menu.tpl'
        ...
        *}
        ...
        {include file='../includes/content/info/info-promo.tpl'
            imgUrl = "header_banners/phone-child-locator.png"
            imgAlt = "phone child locator header"
...
{Content
    ...
    <div id="grid-images" class="row">
        ...
        <div class="col-lg-3 col-md-3 col-sm-3 text-center">
            <img alt="parents follow kids remotely" src="{$img}/landings/track-kids-location.png" width="207px" height="208px" />
        </div>
    </div>
{EndContent}
...
{Content
	...
	<p>Can you put a price tag on the peace of mind and feeling of security, when it comes to child safety? Surely, not. And seeing all the notices on children missing is not helping us to calm down. But making the right choice for a kid phone tracking app will be a life changer for all the over-paranoid parents. The best way to make a good choice is looking through reviews and charts, and pay special attention to other features the app might offer. Even though you might look for a way to monitor child’s location, opting for other functions might help you feel calmer.</p>
		...
		<p>If you seek for an easy and effective way to <a class="a-default" href="/iphone-parental-monitoring.html">track location on your child’s iPhone</a> or Android device, you are not alone. There are more than 10,000 worried parents out there, who have found their peace of mind in a parental monitoring app Pumpic.</p>
            ...
            <div class="row">
                ...
                <div class="bxSliders only-pc">
                    ...
                    <div class="bxItem col-sm-12 col-md-4 col-lg-4 col-xs-12">
                            <img src="{$img}/testimonials/morgan-m.png" alt="pumpic testimonials morgan m" class="testimonial-photo">
                    ...
                    <div class="bxItem col-sm-12 col-md-4 col-lg-4 col-xs-12">
                            <img src="{$img}/testimonials/scarlett-d.png" alt="pumpic testimonials scarlett d" class="testimonial-photo">
                            <div class="testimonial-text">
                    ...
                    <div class="bxItem col-sm-12 col-md-4 col-lg-4 col-xs-12">
                            <img src="{$img}/testimonials/janet-p.png" alt="pumpic testimonials janet p" class="testimonial-photo">
                            <div class="testimonial-text">
