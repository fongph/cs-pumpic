                                    ...
                                    <th>
                                        ...
                                        <div class="premium_wr">
                                            ...
                                            <div class="pricep">
                                                ...
                                                <div class="wr_price_big">
                                                    <span></span><div class="box-currence"><div class="symbol" attr-iso="usd">$</div><div class="curr" id="premium-price-per-month">{$defaultAndroidPremiumPrice}</div></div><span>/ month</span>
                                                </div>

                                                <div class="list_price">
                                                    <form name="price_premium" method="POST" action="/buy.html" class="buy-form-with-offer" autocomplete="off" style="margin-top: 55px;">
                                                        <input id='product_price_premium' type='hidden' name='price[productID]' value='{if isset($getDefaultPremium)}{$defaultAndroidPremiumPrice}{else}0{/if}' class="product_price"/>
