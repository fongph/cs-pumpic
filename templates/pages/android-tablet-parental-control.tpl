	...
	{include file='../includes/main/main-top-menu.tpl'
        ...
        *}
        ...
        {include file='../includes/content/info/info-promo.tpl'
            ...
            imgAlt = "android tablet control header"
...
{EndContent}
    ...
    blockBg='dark'}
        ...
        {*<div class="block-statistick row">
            ...
            <div class="item col-s-sm-12 col-xs-sm-12 col-sm-4 col-md-4 col-lg-4 border-none">
                <section>
                   <img alt="online dangers" src="{$img}/landings/parental-control-for-android.png" width="207px" height="208px" />
                </section>
            </div>
			<div class="item col-s-sm-12 col-xs-sm-12 col-sm-4 col-md-4 col-lg-4 border-none">
			    <section>
        ...
        <table class="table-statistick">
            <tr>
                ...
                <td class="item col-s-sm-12 col-xs-sm-12 col-sm-12 col-md-4 col-lg-4 border-none vertical-aligh-bottom text-center">
                    <img class="statistick-images" alt="online dangers" src="{$img}/landings/parental-control-for-android.png" />
                </td>
                <td class="item col-s-sm-12 col-xs-sm-12 col-sm-12 col-md-4 col-lg-4 border-none">
                    <section>
                        <div class='pb20'><strong class="fz50 color-orange">Parental Control App</strong></div>
            ...
            <div class="row">
                ...
                <div class="bxSliders only-pc">
                    ...
                    <div class="bxItem col-sm-12 col-md-4 col-lg-4 col-xs-12">
                            <img src="{$img}/testimonials/andrea-l.png" alt="pumpic testimonial from andrea l" class="testimonial-photo">
                    ...
                    <div class="bxItem col-sm-12 col-md-4 col-lg-4 col-xs-12">
                            <img src="{$img}/testimonials/martin-s.png" alt="pumpic testimonial from martin s" class="testimonial-photo">
                            <div class="testimonial-text">
