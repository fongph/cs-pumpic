	...
	{include file='../includes/main/main-top-menu.tpl'
        ...
        *}
        ...
        {include file='../includes/content/info/info-promo.tpl'
            ...
            imgAlt = "internet safety software header"
...
{Content
    ...
    <div id="grid-images" class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <div class="pt30 pb20">
                <img class="img-align-right" alt="smartphone vs safe phone" title = "Set up Internet security tool easily" src="{$img}/landings/child-internet-safety-software_icon.png" width="207px" height="208px" />
            ...
            <div class="row">
                ...
                <div class="bxSliders only-pc">
                    ...
                    <div class="bxItem col-sm-12 col-md-4 col-lg-4 col-xs-12">
                            <img src="{$img}/testimonials/bethany-b.png" alt="pumpic testimonials bethany b" class="testimonial-photo">
                    ...
                    <div class="bxItem col-sm-12 col-md-4 col-lg-4 col-xs-12">
                            <img src="{$img}/testimonials/chad-w.png" alt="pumpic testimonials chad w" class="testimonial-photo">
                            <div class="testimonial-text">
                    ...
                    <div class="bxItem col-sm-12 col-md-4 col-lg-4 col-xs-12">
                            <img src="{$img}/testimonials/johanna-l.png" alt="pumpic testimonials johanna l" class="testimonial-photo">
                            <div class="testimonial-text">
