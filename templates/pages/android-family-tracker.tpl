	...
	{include file='../includes/main/main-top-menu.tpl'
        ...
        *}
        ...
        {include file='../includes/content/info/info-promo.tpl'
            ...
            textAlign = "right"
            title = "Android Family Tracker </br> for Your Peace of Mind"
			titleSize = "25px"
            description = "Keep track of your close ones to ensure their safety, </br> locate missing child or trace lost phone."
            promoBuyBlock = "no"
            planPackageBuy = "yes"
            block_video = "no"
            ...
            <div class="item col-s-sm-12 col-xs-sm-12 col-sm-4 col-md-4 col-lg-4">
                <section>
                    ...
                    <span class="text-uppercase">
                        parents are worried that their children may be kidnapped. In the US, every 40 seconds a child goes missing or is abducted. In the half of the incidents a relative of the victim is involved.
                    </span>
                </section>
            </div>
			<div class="item col-s-sm-12 col-xs-sm-12 col-sm-4 col-md-4 col-lg-4">
                <section>
                    ...
                    <span class="text-uppercase">
                        families track kids’ phones using various services. They use either built-in features or some kind of parental control apps to trace mobile devices. Parents say that knowing where the kid is, saves them nerves and time.
                    </span>
                </section>
            </div>
			<div class="item col-s-sm-12 col-xs-sm-12 col-sm-4 col-md-4 col-lg-4">
                <section>
                    <div><strong class="fz50 color-orange">77%</strong></div>
                    <span class="text-uppercase">
                        kids know their parents use parental monitoring apps. At the same time, less than 50% of teens are bothered by parents keeping an eye on them and say it doesn't bother them that much.
                    </span>
                </section>
            </div>
...
<p>Of course, using a family tracker to trace your partner or kids with GPS or via their mobile device is definitely an arguable topic. And if checking in on another grown-up (for example, wife or husband) is indisputably yours choice to make, the case of tracking kids is quite different. On the one hand, it is your right and even duty as a parent to make sure your kids are OK wherever they are, if they have arrived at their destinations and if they are where they say they’ll be. On the other hand, there is the argument that using GPS to track your kids shows that you don’t trust them.</p>
<p>Today, there are dozens of ways to trace the location of your relatives – from tiny keychain devices to multifunctional mobile apps that can be installed on a smartphone. There is even a clock-styled display that can show all family members whereabouts! Anyway, it is absolutely up to you to choose a way to stay aware of where your close ones are and find a balance between tracking and privacy.</p>  
...
{Content 
    ...
    <div id="grid-images" class="row">
        <div class="col-lg-9 col-md-9 col-sm-9">
            <h2 class="h2 text-right-important">Case: How Family Tracking Helped to Locate Missing Child</h2>
            <div class="pt30 pb20">
			<p>The ability to use a cell phone or a tablet as a GPS tracking device is arguably one of the greatest innovations in Mobile technology. Whether you need to track Android device, iPhone or iPad – there are plenty respective tools to accomplish this mission. And, by the way, there already have been examples when family tracking apps helped to find missing children.</p>
...
<div class="light">
        <div class="container">
                <h2 class="text-center">How Pumpic Secures Your Child in the Real and Digital Worlds</h2>
                <div class="row">
                        <div class="col-sm-4 col-md-4 col-lg-4">
                                <div class="feature">
                                        ...
                                        <ul class="feature_list">
                                                <li>Keep track of current location</li>
                        ...
                        <div class="col-sm-4 col-md-4 col-lg-4">
                                <div class="feature">
                                        ...
                                        <ul class="feature_list">
                                                <li>View Internet browsing history</li>
                                                <li>Block inappropriate websites</li>
                                                <li>Follow social networks posts and media</li>
										</ul>
                                </div>
                        </div>
                        <div class="col-sm-4 col-md-4 col-lg-4">
        ...
        <div class="light">
    <div class="container">
            <h2 class="text-center testimonial-title">Taking Care of Over 10,000 Families Worldwide</h2>
            <div class="row">
