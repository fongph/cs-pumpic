...
final class WP_Customize_Manager {
	...
	public function register_controls() {
		...
		$this->add_section( 'home_show', array(
			'title'          => __( 'Settings Home Show' ),
		//	'theme_supports' => 'static-front-page',
			'priority'       => 19,
			'description'    => __( 'Your theme settigs show home elements.' ),
		) );

                
                $this->add_setting('home_show_sell', array(
                    'default'    => get_option( 'home_show_sell' ),
                    'capability'     => 'manage_options',
                    'type'           => 'option',
                ));
                ...
                $this->add_control(
                    new WP_Customize_Control(
                        ...
                        'home_show_sell',
                        array(
                            'label'     => __('Show Home Sell element'),
                            'section'   => 'home_show',
                            'settings'  => 'home_show_sell',
                            'type'      => 'checkbox',
                        )
                    )
                );
                
                $this->add_setting('home_show_order_button', array(
                    'default'    => get_option( 'home_show_order_button' ),
                    'capability'     => 'manage_options',
                    'type'           => 'option',
                ));
                ...
                $this->add_control(
                    new WP_Customize_Control(
                        $this,
                        'home_show_order_button',
                        array(
                            'label'     => __('Show Home Button Order element'),
                            'section'   => 'home_show',
                            'settings'  => 'home_show_order_button',
                            'type'      => 'checkbox',
                        )
                    )
                );
                
                $this->add_setting('home_show_small_banner', array(
                    'default'    => get_option( 'home_show_small_banner' ),
                    'capability'     => 'manage_options',
                    'type'           => 'option',
                ));
                ...
                $this->add_control(
                    new WP_Customize_Control(
                        $this,
                        'home_show_small_banner',
                        array(
                            'label'     => __('Show Home Small Banner element'),
                            'section'   => 'home_show',
                            'settings'  => 'home_show_small_banner',
                            'type'      => 'checkbox',
                        )
                    )
                );
                
                $this->add_setting('home_show_graphics', array(
                    'default'    => get_option( 'home_show_graphics' ),
                    'capability'     => 'manage_options',
                    'type'           => 'option',
                ));
                ...
                $this->add_control(
                    new WP_Customize_Control(
                        ...
                        'home_show_graphics',
                        array(
                            'label'     => __('Show Home Graphics ("How to order") element'),
                            'section'   => 'home_show',
                            'settings'  => 'home_show_graphics',
                            'type'      => 'checkbox',
                        )
                    )
                );
