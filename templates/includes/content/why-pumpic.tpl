            ...
            <div class="col-sm-10 col-md-10 col-lg-10 col-sm-offset-1 col-md-offset-1 col-lg-offset-1 gutter-wide">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-4 col-lg-4 col-xs-12">
                        ...
                        <p class="text-center">Follow the guidelines and start remote monitoring from your Control Panel right after the setup. Get physical access to the target device once and install the app in less than 5 minutes. <br/><br/>For iPhone monitoring via iCloud account you don't even need to install software ont he target phone.</p>
                    </div>
                    <div class="col-sm-12 col-md-4 col-lg-4 col-xs-12">
