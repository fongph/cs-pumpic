	...
	{include file='../includes/main/main-top-menu.tpl'
        ...
        *}
        ...
        {include file='../includes/content/info/info-promo.tpl'
            imgUrl = "header_banners/best-free-parental-control-apps-for-android-header.png"
            imgAlt = "Best Parental Control Software for Android" 
...
{Content 
    ...
    blockBg='light'}
        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <div class="pt30 pb20">
                <img class="img-align-left" alt="Best Parental Control Software for Android Screenshot" src="{$img}/landings/best-android-parental-control-app/2-techno-parental-control.png" width="207px" height="208px" />
                <img class="app-icon-right" src="{$img}/landings/best-android-parental-control-app/techno-parental-control-logo.png" alt="Best Parental Control Software for Android Logo">
...
{Content 
    ...
    <div id="grid-images" class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <div class="pt30 pb20">
                <img class="img-align-right" alt="Best Parental Control Software for Android Screenshot" src="{$img}/landings/best-android-parental-control-app/3-kids-shell.png" width="207px" height="208px" />
                <img class="app-icon-left" src="{$img}/landings/best-android-parental-control-app/kids-shell-logo.png" alt="Best Parental Control Software for Android Logo">
...
{Content 
    ...
    blockBg='light'}
        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <div class="pt30 pb20">
                <img class="img-align-left" alt="Best Parental Control Software for Android Screenshot" src="{$img}/landings/best-android-parental-control-app/4-kids-zone.png" width="207px" height="208px" />
                <img class="app-icon-right" src="{$img}/landings/best-android-parental-control-app/kids-zone-logo.png" alt="Best Parental Control Software for Android Logo">
...
{Content 
    ...
    <div id="grid-images" class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
            <h2 class="h3 text-left">Kaspersky Safe Kids Review</h3>
            <div class="pt30 pb20">
                <img class="img-align-right" alt="Best Parental Control Software for Android Screenshot" src="{$img}/landings/best-android-parental-control-app/5-kaspersky-safe-kids.png" width="207px" height="208px" />
                <img class="app-icon-left" src="{$img}/landings/best-android-parental-control-app/kaspersky-safe-kids-logo.png" alt="Best Parental Control Software for Android Logo">
...
{Content 
    ...
    blockBg='light'}
        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <div class="pt30 pb20">
                <img class="img-align-left" alt="Best Parental Control Software for Android Screenshot" src="{$img}/landings/best-android-parental-control-app/6-my-mobile-watchdog.png" width="207px" height="208px" />
                <img class="app-icon-right" src="{$img}/landings/best-android-parental-control-app/my-mobile-watchdog-logo.png" alt="Best Parental Control Software for Android Logo">
...
{Content 
    ...
    <div id="grid-images" class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
            <h2 class="h3 text-left">Bitdefender Parental Control Review</h3>
            <div class="pt30 pb20">
                <img class="img-align-right" alt="Best Parental Control Software for Android Screenshot" src="{$img}/landings/best-android-parental-control-app/9-bitdefender.png" width="207px" height="208px" />
                <img class="app-icon-left" src="{$img}/landings/best-android-parental-control-app/bitdefender-parental-control.png" alt="Best Parental Control Software for Android Logo">
...
{Content 
    ...
    blockBg='light'}
        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            <h2 class="h3 text-right">McAfee Family Protection Review</h3>
            <div class="pt30 pb20">
                <img class="img-align-left" alt="Best Parental Control Software for Android Screenshot" src="{$img}/landings/best-android-parental-control-app/10-mcafee-family-protection.png" width="207px" height="208px" />
                <img class="app-icon-right" src="{$img}/landings/best-android-parental-control-app/mcafee-family-protection-logo.png" alt="Best Parental Control Software for Android Logo">
    ...
    <div class="container">
            ...
            <div class="row">
                ...
                <div class="bxSliders only-pc">
                    ...
                    <div class="bxItem col-sm-12 col-md-4 col-lg-4 col-xs-12">
                            <img src="{$img}/testimonials/steve-a-14.png" alt="" class="testimonial-photo">
                            <div class="testimonial-text">
                                    <h4>Steve A. – father of 14-year-old son</h4>
                                    <p>“My college shared a link on Facebook with a review of the best parental control apps for Android. That was an unexpected pleasure as I’d been looking for monitoring for my kid then. I read it and Pumpic attracted my attention among others. First of all the app has a great design. I really liked that it looked good and was very easy-to-use. When I tried a month subscription, I was so happy to see that this app can do anything I need to secure my son on his smartphone. I now monitor his calls, text messages, track his location when I’m not sure where he actually is. And Internet monitoring is a huge benefit. I can prevent him from visiting misgiving websites and seeing adult content. Strongly recommend the app to parents!”</p>
                            </div>
                    </div>
                    <div class="bxItem col-sm-12 col-md-4 col-lg-4 col-xs-12">
