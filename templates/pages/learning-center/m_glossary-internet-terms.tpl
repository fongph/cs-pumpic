                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <div id="common">
                                                    ...
                                                    <p class="text-justify {*font-light*}">Below you’ll find the list of the most popular terms and abbreviations teenagers use while chatting online or writing text messages. Have a look and try to keep them in mind to know whether your kid is hiding something from you.</p>
                                                    <div class="{*row*} block-content background-width clearfix">    
                                                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                            <ul class="list_orange_circle">
                                                                ...
                                                                <li>GTG – Got to Go</li>
																<li>GTFA – Google The F*cking Answer</li>
                                            ...
                                            <li>
                                                <div id="sexting">
                                                    ...
                                                    <p class="text-justify {*font-light*}">SSexting refers to sending messages with sexual content, primarily via SMS, IM chats, and online communication. View and remember the following list of the most widely used sexting terms to prevent your kids from online predators and other possible dangers on the Web.</p>
                                                    <div class="{*row*} block-content background-width clearfix">    
                                                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                            <ul class="list_orange_circle">
                                            ...
                                            <li>
                                                <div id="drug">
                                                    ...
                                                    <p class="text-justify {*font-light*}">Below you’ll find the list of the most popular illicit drugs and their street names. Bear them in mind to stay aware if your kids use any of them. If they do, consider that they are a footstep from possible danger. Prevent your children from using drugs before it’s too late.</p>
                                                    <div class="{*row*} block-content background-width clearfix">    
                                                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                            <ul class="list_orange_circle">
                                                                <li>
                                            ...
                                            <li>
                                                <div id="dating">
                                                    ...
                                                    <p class="text-justify {*font-light*}">Below you’ll find the list of terms commonly used in online dating. Have a look at them and keep in mind. Check if your children use any of them. Do not let strangers or online predators contact your kids with inappropriate offers. Prevent danger before it happens.</p>
                                                    <div class="{*row*} block-content background-width clearfix">    
                                                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                            <ul class="list_orange_circle">
                                                    ...
                                                    <div class="{*row*} block-content background-width clearfix">    
                                                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                            <ul class="list_orange_circle">
                                                                ...
                                                                <li>
                                                                    <b>OS</b> – operating system – special software, which manages hardware or any computer, smartphone or tablet. Popular operating systems: Apple iOS (or simply iOS), Android, Blackberry, Windows.
                                                                </li>
                                                                <li>
                                                        ...
                                                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                            <ul class="list_orange_circle">
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <b>Why dangerous:</b>
                                                                    <ul class="list_green">
                                                                        <li>if someone knows your username or email, he or she might contact you easily
                                                                            <br /><i>(children tend to share their emails and usernames on Facebook)</i>;</li>
                                            ...
                                            <li>
                                                <div id="emojis">
                                                    ...
                                                    <p class="text-justify {*font-light*}">There is no point in showing the entire list of all possible smiles that might be used to bring about harm. There are too many of them. Literally, all of them, if combined in a particular way, might appear as offensive ones. Instead, let’s give an example from a real life situation.</p>
                                                    <div class="{*row*} block-content background-width clearfix">    
                                                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                            <ol class="list_numbers_green">
                                                                ...
                                                                <li>
                                                                    A teenager from Brooklyn was accused of a terroristic threat because of his Facebook status. The boy used emojis and pictured a police officer with a gun near the head. At the same time, there were no verbal threats, only emoticons. He was charged 7 years in custody, but ultimately the jury overturned conviction. Of course, that probably was too much as for emojis and a teenager. However, it once again means that one can be arrested and sentenced for emoticons.
                                                                </li>
                                                            </ol>
                                                        </div>
