<style>
    ...
    @media only screen and (max-width: 768px) {
        #fly_features.christmass-banner {
            background-image: url("/images/fly_features/christmas_banner_bg_xs.png"),linear-gradient(to left bottom,#204d84,#9da3ac,#bb6884) ;
    ...
    {*<div id="fly_features">*}
        ...
        {*<div id="fly_top">*}
            {*<h2 id="fly-features-h2">iCloud Monitoring<br>*}
                {*for iOS <img src="/images/fly_features/ios10-icon.svg" width="20" height="20" alt=""><br>*}
