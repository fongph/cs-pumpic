                                                    ...
                                                    <div class="basic_wr">
                                                        ...
                                                        <div class="priceb">
                                                            ...
                                                            <ul>
                                                                ...
                                                                <li data-toggle="tooltip" data-placement="top" title="Monitor iPhones, iPads, and iPods Touch without jailbreak. View Calls, Text messages, Photos, Contacts, Browsing History, Bookmarks, Calendar, Skype, and WhatsApp.{*Monitoring of iPhones, iPads and iPods Touch without jailbreak.  View SMS, Calls, Contacts, Browser History, Bookmarks, Calendar events.*}"><i class="icon-cancel"></i> iCloud (<span class="fz13">jailbreak-free</span>)</li>
