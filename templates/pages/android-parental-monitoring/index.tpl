            ...
            <div class="item col-s-sm-12 col-xs-sm-12 col-sm-4 col-md-4 col-lg-4">
                <section>
                    ...
                    <span class="text-uppercase">
                        children worldwide use smartphones, 33% of them are under 8 years old
                    </span>
                </section>
            </div>
            <div class="item col-s-sm-12 col-xs-sm-12 col-sm-4 col-md-4 col-lg-4">
...
{Content
    ...
    blockBg='light'}
    <p>One can hardly imagine life without a mobile phone connected to the Internet these days. When it comes to children, we see that online reality means almost everything to them, being an essential part of communication and spare time spending. Mobile gadgets also allow kids to educate themselves and find out more about the world around. However, along with great opportunities there come certain issues.</p>
    <ul class="list-images">
        <li><img src="{$img}/list/online-predators-icon.png" alt="Online Predators" class="lc-1" /><strong>Online predators.</strong> Sexual predators actually exist and threaten your kids’ security. Boys and girls, who are more tech-savvy than their parents, and more emotionally vulnerable due to personal issues, are the primary target. Most online predators are masters at manipulating youngsters. They know how to deceive your children pretending care and friendship. They use anonymity the Internet provides and can be whomever they want to get into your kids’ confidence. A threat starts as a harmless online talk and usually turns out to be sexual seduction in real life. An Android child monitoring app will let you know whom your kids chat with online, and thus, you will be able to protect them against online predators attacks.</li>
        <li><img src="{$img}/list/cyberbullying-icon.png" alt="Cyberbullying" class="lc-2" /><strong>Cyberbullies.</strong> Talk to your kids and find out if someone offends them. They might receive text messages with threats or bad words. Cyberbullying images can be posted anonymously on social networks and spread quickly over the Internet. More often than not, it is hard to find the source of cyberbullying, since the offender can be not even a real person. Parental monitoring will allow you to track your kids’ online activities, follow social media, as well as text messages they receive. Such software will let you find out if any threat exists, and take action before it’s too late.</li>
        <li><img src="{$img}/list/sexting-icon.png" alt="Sexting and Explicit Content" class="lc-3" /><strong>Sexting.</strong> Today children develop faster than their parents did before. When it comes to sexual life, their development is no less fast. Some youngsters consider exchanging SMS, photos, and <a class="a-default" href="/parental-control-on-youtube-android.html" target="_blank">videos with sexual content</a> a part of growing up. As the statistics show, about 22% of underage children are engaged in sexting. They think it will help them build relations with the opposite sex or stand out from their classmates and look more adult-like. <a class="a-default" href="/parental-control-apps-android-2.3-vs-4.html" target="_blank">Parental controls on Android</a> phones will help you monitor your children’s interactions, view photos, and videos they send and receive, and thus, you will be able to intervene when situation tends to go beyond the pale.</li>
    </ul>
    <p>While your children are underage, you as a careful parent are responsible for them. You should secure their pastime by all means, and sometimes take steps they might consider unnecessary interference. However, as long as <a class="a-default" target="_blank" href="/online-safety-rules-for-teens.html">safety for kids</a> is your top priority, you should do what is needed. Pumpic parental control software for Android installed on your children’s smartphones and tablets will help you monitor applications they use, screen time, texts and calls they receive, photos and video files, as well as any other activities they perform. You can even see their browser search in the incognito mode. Pumpic provides you with countless opportunities to protect your kids.</p>
            ...
            <div class="row">
                ...
                <div class="bxSliders only-pc">
                    ...
                    <div class="bxItem col-sm-12 col-md-4 col-lg-4 col-xs-12">
                            <img src="{$img}/testimonials/susan-l.png" alt="pumpic testimonial from susan l" class="testimonial-photo">
                            <div class="testimonial-text">
                                    <h4>Susan L. (Cheyenne, WY)</h4>
                                    <p>“Pumpic helped me find out that my daughter, 16 years old, was involved in sexting by her boyfriend. Frankly, the truth was more than ugly. When I saw all those messages full of mean and vulgarity, I was raving with fury. We had a serious talk with my daughter and parents of this “boyfriend”. We both agreed that it must never ever happen again. Thanks Pumpic for keeping me informed.”</p>
                            </div>
                    </div>
                    <div class="bxItem col-sm-12 col-md-4 col-lg-4 col-xs-12">
                            <img src="{$img}/testimonials/melinda-j.png" alt="pumpic testimonial from melinda j" class="testimonial-photo">
                            <div class="testimonial-text">
                    ...
                    <div class="bxItem col-sm-12 col-md-4 col-lg-4 col-xs-12">
                            <img src="{$img}/testimonials/sandy-and-patrick-k.png" alt="pumpic testimonial from sandy and patrick k" class="testimonial-photo">
                            <div class="testimonial-text">
