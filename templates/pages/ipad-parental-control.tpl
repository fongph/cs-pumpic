	...
	{include file='../includes/main/main-top-menu.tpl'
        ...
        *}
        ...
        {include file='../includes/content/info/info-promo.tpl'
            imgUrl = "header_banners/ipad-parental-control.png"
...
{Content 
    styleTitle="h2"    
    title="How to Protect Kids on iPad"
    blockBg='dark'}
        ...
        {*<div class="block-statistick row">
            ...
            <div class="item col-s-sm-12 col-xs-sm-12 col-sm-4 col-md-4 col-lg-4 border-none">
                <section>
                   <img alt="stop cyberbullying with Pumpic" src="{$img}/landings/parental-control-for-ipad.png" width="207px" height="208px" />
                </section>
            </div>
			<div class="item col-s-sm-12 col-xs-sm-12 col-sm-4 col-md-4 col-lg-4 border-none">
			    <section>
...
<div class="light">
        <div class="container">
                <h2 class="text-center">Set Parental Control on iPad</h2>
                <div class="row">
                        <div class="col-sm-4 col-md-4 col-lg-4">
                                <div class="feature">
                                        <img src="{$img}/icons/icon-mobile-secure.png" alt="cell phone monitoring">
                                        <h3>Monitor tablet use</h3>
                                        <ul class="feature_list">
                                                <li>Control downloaded and built-in apps</li>
                                                <li>View notes, calendar, and contacts</li>
                                                <li>Monitor photos and video files</li>
                                        </ul>
                                </div>
                        </div>
                        <div class="col-sm-4 col-md-4 col-lg-4">
                                <div class="feature">
                                        ...
                                        <ul class="feature_list">
                                                ...
                                                <li>Track social media and online chats</li>
                        ...
                        <div class="col-sm-4 col-md-4 col-lg-4">
                                <div class="feature">
                                        ...
                                        <ul class="feature_list">
                                                <li>Follow current GPS location</li>
                                                <li>Track the entire route history</li>
