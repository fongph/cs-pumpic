                    ...
                    <div class="col-sm-4 col-md-4 col-lg-4">
                        <div class="feature">
                            ...
                            <ul class="feature_list">
                                <li>Monitor text content</li>
                                <li>SMS, MMS, and iMessages</li>
