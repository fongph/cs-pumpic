                        ...
                        <li class="android_list">
                            <label class="price_label label_radio hover_label_radio {if $item.period == '6'}r_on{else}r_off{/if}">
                                ...
                                <div class="package_price">
                                    <strong>
                                        <div class="box-currence"><div class="symbol" attr-iso="usd">$</div><div class="curr">{$item.discount}</div></div>
                                    </strong>
                                </div>
                                <div class="package_offer_price">
                                    <strong>
                                        <div class="box-currence"><div class="symbol" attr-iso="usd">$</div><div class="curr">{$getProducts.androidBasicDouble[$key].discount}</div></div>
                                    </strong>
                                </div> *}
                            </label>
                        </li>
