		...
		if ( function_exists( 'get_coauthors' ) && count( get_coauthors( get_the_id() ) ) > 1 ){
			...
			$co_authors = get_coauthors();
				...
				if ( $settings['author_links'] == "not_linked" ){ 
					...
					$output['content'] .= '<div id="sab-author">12312312312312312</div><div id="sab-author"><span style="color:' . $settings['highlight_color'] . ';">' . $sab_coauthor->display_name . '</span></div><div id="sab-gravatar"><span>';
					...
					$output['content'] .= '<div id="sab-author">12312312312312312</div><div id="sab-author"><a rel="'.$nofollowshort.'author" href="' . $author_name_link . '" title="' . get_the_author_meta( 'display_name', $zeeauthor) .'" target="' . $settings['link_target'] . '">' . $sab_coauthor->display_name . '</a></div><div id="sab-gravatar"><a '.$nofollow.'href="' . $author_avatar_link . '" target="' . $settings['link_target'] . '">';
					if( !get_the_author_meta('avatar-url', $zeeauthor) ){
						$output['content'] .= get_avatar( get_the_author_meta('ID', $zeeauthor), $gravatar, '', $sab_coauthor->display_name );
					}else{
						$output['content'] .= '<img alt="' . $sab_coauthor->display_name . '" src="'.get_the_author_meta('avatar-url', $zeeauthor).'" />';
