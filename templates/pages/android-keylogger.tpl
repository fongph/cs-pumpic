	...
	{include file='../includes/main/main-top-menu.tpl'
        ...
        *}
        ...
        {include file='../includes/content/info/info-promo.tpl'
			...
			titleSize = "25px"
            description = "What are the main functions of keylogger app for Android? <br />Check the device usage, all keystrokes typed, and much more."
            promoBuyBlock = "no"
            planPackageBuy = "yes"
            block_video = "yes"
            ...
            <div class="item col-s-sm-12 col-xs-sm-12 col-sm-4 col-md-4 col-lg-4">
                <section>
                    ...
                    <span class="text-uppercase">
                        smartphone owners use text messaging as one of the most popular way of communication
                    </span>
                </section>
            </div>
			<div class="item col-s-sm-12 col-xs-sm-12 col-sm-4 col-md-4 col-lg-4">
                <section>
                    ...
                    <span class="text-uppercase">
                        teenagers use smartphones to go online every day
                    </span>
                </section>
            </div>
			<div class="item col-s-sm-12 col-xs-sm-12 col-sm-4 col-md-4 col-lg-4">
                <section>
                    ...
                    <span class="text-uppercase">
                        parents worried that their children are exposed to online risks and dangers
                    </span>
                </section>
            </div>
...
<p>You need to know that using keyloggers are still legal in many states of the United States and elsewhere in the world. But when the software is used by employers or suspicious partners, it is considered to be unethical and unlawful as it interacts the personal freedom.</p>
<p>But what if you are a careful parent and want to protect your child from the online dangers, such as cyberbullying, sexting, and all other forms of violent behavior? The only right solution is to use parental monitoring apps, like Pumpic. They are legal to use, and let the parents know what is going on with their children. Moreover, it is easily installed by downloading Android keylogger apk file. Are you interested? Keep reading!</p>
...
{Content 
    ...
    <div id="grid-images" class="row">
        <div class="col-lg-9 col-md-9 col-sm-9">
            <h2 class="h2 text-right-important">Opportunities Parental Tracking Apps Provide</h2>
            <div class="pt30 pb20">
...
<div class="light">
        <div class="container">
                <h2 class="text-center">Get the Most of the Monitoring Features</h2>
                <div class="row">
                        <div class="col-sm-4 col-md-4 col-lg-4">
                                <div class="feature">
                                        <img src="{$img}/icons/icon-mobile-secure.png" alt="cell phone monitoring">
                                        <h3>Check mobile phone usage</h3>
                                        <ul class="feature_list">
                                                <li>View the duration of calls</li>
                                                <li>Read messages</li>
                                                <li>Watch notes and media files</li>
                                        </ul>
                                </div>
                        </div>
                        <div class="col-sm-4 col-md-4 col-lg-4">
                                <div class="feature">
                                        ...
                                        <h3>Supervise online activity</h3>
                                        <ul class="feature_list">
                                                <li>Follow bookmarks</li>
                                                <li>Block links and sites</li>
                                                <li>Oversee social media</li>
                                        </ul>
                                </div>
                        </div>
                        <div class="col-sm-4 col-md-4 col-lg-4">
                                <div class="feature">
                                        ...
                                        <h3>Control the phone remotely</h3>
                                        <ul class="feature_list">
                                                <li>Lock the device</li>
                                                <li>Keep track of location</li>
        ...
        title = "Unique Features for Topnotch Security"
        description = "Pumpic is proud to have more than 24 supreme features that ensure the best possible protection from all online threats. From now on, parents can get the most of this parental monitoring application and sleep well without worrying about their kids. Pumpic is an extremely valuable app when it comes to finding the truth about using mobile phone or tablet. Its unique Android keystroke logger will help to monitor all activities on a particular device at the chosen moment. Get acquainted with the following features and functions that guarantee the best protection."
        blockBg="dark"
            android = "yes"
        ...
        <div class="light">
    <div class="container">
            <h2 class="text-center testimonial-title">Trusted by More Than 10,000 Users Worldwide:</h2>
            <div class="row">
