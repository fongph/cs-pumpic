...
class Curl 
{
        ...
        if (is_array($url_mixed)) {
            ...
            foreach ($url_mixed as $url) {
                ...
                if (!($curlm_error_code === CURLM_OK)) {
                    throw new Exception('cURL multi add handle error: ' . curl_multi_strerror($curlm_error_code));
                }
            }
    ...
    private function parseHeaders($raw_headers)
    {
        ...
        $http_headers = new CaseInsensitiveArray(); // new CaseInsensitiveArray();
