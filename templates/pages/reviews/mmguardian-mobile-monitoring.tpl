                ...
                <div class="box-state">
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <p>
                                MMGuardian will let you monitor cell phone activity, block and limit apps, ban phone numbers and words, as well as lock a device remotely.
                            </p>
                    ...
                    <div class="box-graph">
                        <img src="{$img}/diagrams/chart/03-pumpic-review-mmguardian-min.png" height="368" width="686" alt="">
                    </div>
