	...
	{include file='../includes/main/main-top-menu.tpl'
        ...
        *}
        ...
        {include file='../includes/content/info/info-promo.tpl'
            ...
            imgAlt = "android tablet parental controls header"
...
{Content
    ...
    <div id="grid-images" class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <div class="pt30 pb20">
                <img class="img-align-right" alt="kaspersky safe kids mobile screen" src="{$img}/landings/best-android-parental-control-app/kaspersky-safe-kids-review.png" width="207px" height="208px" />
            ...
            <div class="row">
                ...
                <div class="bxSliders only-pc">
                    ...
                    <div class="bxItem col-sm-12 col-md-4 col-lg-4 col-xs-12">
                            <img src="{$img}/testimonials/alex-t.png" alt="pumpic testimonial from alex t" class="testimonial-photo">
                    ...
                    <div class="bxItem col-sm-12 col-md-4 col-lg-4 col-xs-12">
                            <img src="{$img}/testimonials/steve-a.png" alt="pumpic testimonial from steve a" class="testimonial-photo">
                            <div class="testimonial-text">
