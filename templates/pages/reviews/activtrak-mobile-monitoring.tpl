...
{include file='../../includes/main/main-header.tpl'
    ...
    title="ActivTrak parental control software review"
    description="Read editor's reviews, view a features comparison table, and learn more about ActivTrak mobile monitoring solution."
}    
