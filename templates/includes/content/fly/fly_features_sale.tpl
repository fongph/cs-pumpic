...
function ready() {
    ...
    if ((screen.width >= 1024) && (screen.height >= 768)) {
        document.getElementsByClassName('fly_banner_sale_img')[0].setAttribute("src", "{$img}/fly_features/fle_banner_sale.png");
    }
    else {
        document.getElementsByClassName('fly_banner_sale_img')[0].setAttribute("src", "{$img}/fly_features/fly_banner_sale_responce.png");
    }
};
