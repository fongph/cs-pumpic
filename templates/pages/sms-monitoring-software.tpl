                                ...
                                <div class="col-lg-10 col-md-12 col-sm-12 col-lg-offset-1 banner-header">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6">
                                        <div class="visual-text text-right">
                                            <h1 class="title">SMS MONITORING <br />PARENTAL CONTROL APP</h1>
				...
				<div class="row">
					...
					<div class="col-sm-5 col-md-5 col-lg-5">
						<div class="ipad-text">
							...
							<p>Try Control Panel demo to see Pumpic SMS Monitoring in use.
                                                        <br />Buy Pumpic to protect your kids and view their SMS right now.</p>
						</div>
					</div>
				</div>
			</div>
