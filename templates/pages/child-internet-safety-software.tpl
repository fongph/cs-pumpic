        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <div class="pt30 pb20">
				...
				<ul class="list-images">
				   ...
				   <li><img src="{$img}/landings/check-icon.png" alt="Check Mark" class="lc-1" />It has a <strong>wide range of functions</strong> – besides web filtering, Pumpic monitors calls, SMS and IM messages, follows social media accounts, blocks apps, tracks GPS location and much more.</li>
