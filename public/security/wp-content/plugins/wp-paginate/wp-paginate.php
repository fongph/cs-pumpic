    ...
    class WPPaginate {
        ...
        function paginate($args = false) {
            ...
            if ($pages > 1) {
							...
							if($preset === 'default')
                $output .= sprintf('<ul class="pagination wp-paginate ' . $font . '%s">', ($this->type === 'posts') ? '' : ' wp-paginate-comments');
							else
                $output .= sprintf('<ul class="pagination wp-paginate ' . $preset . ' ' . $font . '%s">', ($this->type === 'posts') ? '' : ' wp-paginate-comments');
