                                                    ...
                                                    <div class="basic_wr">
                                                        ...
                                                        <div class="priceb">
                                                            ...
                                                            <ul>
                                                                ...
                                                                <li data-toggle="tooltip" data-placement="top" title="Block SMS from specific senders and/or containing specific keywords. <div class='br'><strong>iOS: Jailbreak Needed</strong><strong>Android: Root Required</strong></div><div class='br'><strong>Not available for Android 4.4 and newer versions.</strong></div>"><i class="icon-ok"></i> SMS blocking </li>
