                                                ...
                                                <div class="dtable">
                                                    <div class="dtable-cell text-center">
                                                        ...
                                                        <div class="wr_price_big">
                                                            ...
                                                            <div class="box-currence">
                                                                <div class="symbol" attr-iso="usd">$</div>
                                                                <div class="curr icloud-price-per-month">23.33</div>
                                                            </div><span> / month</span>
                                                        </div>
                                                    </div>
                                                </div>
...
<script>
    $(document).ready(function () {
        ...
        $('input[data-period="6"]').closest('ul').find('label')
                .removeClass('r_on')
                .addClass('r_off');

        $('input[data-period="6"]').closest('ul').find('input')
                .removeAttr('checked');
        $('#product_price_premium').val($('input[data-period="3"]').val())

        $('input[data-period="6"]').attr('checked', 'checked');

        $('input[data-period="6"]').closest('label')
                .addClass('r_on')
                .removeClass('r_off');
    })
