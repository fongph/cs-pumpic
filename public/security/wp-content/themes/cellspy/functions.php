...
if(!function_exists('get_bottom')) {
    function get_bottom($name = null)
    {
        do_action('get_bottom', $name);

        $templates = array();
        $name = (string)$name;
        if ('' !== $name)
            $templates[] = "bottom-{$name}.php";

        $templates[] = 'bottom.php';

        // Backward compat code will be removed in a future release
        if ('' == locate_template($templates, true))
            load_template(ABSPATH . WPINC . '/theme-compat/bottom.php');
    }
}
...
function cellspy_widgets_init() {
		...
		'description' => __( 'Sidebar below the banner', 'cellspy' ),
...
<div class="box-form-subscribe shortcode-form dark">              
	<form method="POST" action="https://pumpic.com/security-subscribe-form-mailChimp.html" name="subscribe-'.get_the_ID().'">
		...
		<div class="row">
			<div class="col-s-sm-12 col-sm-12 col-md-12 col-lg-12">
				<div class="visual-text visual-shortcode">
