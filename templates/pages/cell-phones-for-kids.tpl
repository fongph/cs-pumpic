...
{Content
    ...
    <div id="grid-images" class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <div class="pt30 pb20">
                <img src="{$img}/landings/cell-phones-for-kids.png" style="float: right; padding-left: 35px;" alt="smartphone vs safe phone" />
            ...
            <div class="row">
                ...
                <div class="bxSliders only-pc">
                    ...
                    <div class="bxItem col-sm-12 col-md-4 col-lg-4 col-xs-12">
                            <img src="{$img}/testimonials/jessica-l.png" alt="pumpic testimonials jessica l" class="testimonial-photo">
                    ...
                    <div class="bxItem col-sm-12 col-md-4 col-lg-4 col-xs-12">
                            <img src="{$img}/testimonials/peter-g.png" alt="pumpic testimonials peter g" class="testimonial-photo">
                            <div class="testimonial-text">
                    ...
                    <div class="bxItem col-sm-12 col-md-4 col-lg-4 col-xs-12">
                            <img src="{$img}/testimonials/zoe-h.png" alt="pumpic testimonials zoe h" class="testimonial-photo">
                            <div class="testimonial-text">
