                                ...
                                <div class="logo">
                                    <a href="<?php echo getStaticUrl();?>">pumpic</a>
                                                        ...
                                                        <div class='box-cp pull-right'>   
                                                            <a href="<?php echo getSchema(); ?>demo.pumpic.com/setDevice/126?redirect_url=cp/calls" target="_blank" class="btn btn-sm btn-orange btn-success visible-lg cp-login">Demo</a>
                                                        </div>
