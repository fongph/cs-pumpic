...
{Content 
	...
	<p>Even though for the last couple of years the number of crimes involving kidnapping has went down, about a half of teen parents are worried their kids might be kidnapped. In response to the parental concern, the market has boomed with <a class="a-default" href="/android-family-tracker.html" target="blank">family tracking devices</a>. But once smartphones became widespread, a GPS tracking app for iPhone or Android has become a must-have.</p>
