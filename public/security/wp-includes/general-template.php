 ...
 *
 * Includes the footer template for a theme or if a name is specified then a
 * specialised bottom will be included.
 *
 * For the parameter, if the file is called "bottom-special.php" then specify
 * "special".
 *
 * @since 1.5.0
 *
 ...
 *
 * @param string $name The name of the specialised bottom.
 */
