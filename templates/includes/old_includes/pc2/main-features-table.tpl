        ...
        <div class="container">
                ...
                <div class="row">
                    ...
                    <div id="table-container" class="table-col-3 table-md-col-3 table-sm-col-3">
                        <h1 class="text-center">To protect your kids and prevent them from inappropriate time spending, Pumpic provides a large variety of monitoring functions, which make remote parenting quick, worriless and simple.</h1>
                        <section>
