	...
	{include file='../includes/main/main-top-menu.tpl'
        ...
        *}
        ...
        {include file='../includes/content/info/info-promo.tpl'
            ...
            imgAlt = "iPhone Location Tracking"
            imgAlign = "left bottom"
            imgVerticalAlign = "bottom"
			imgTitle = "Knowing your kid's whereabouts is priceless"
            textAlign = "left"
            title = "iPhone Location Tracking App</br>Know Where Your Kid Really Is"
			titleSize = "25px"
            description = "Keep track of your child’s whereabouts.</br>Set safe and restricted areas, get alerts."
            promoBuyBlock = "no"
            planPackageBuy = "yes"
            block_video = "no"
            ...
            <div class="item col-s-sm-12 col-xs-sm-12 col-sm-4 col-md-4 col-lg-4">
                <section>
                    ...
                    <span class="text-uppercase">
                        American teenagers own an iPhone, according to a 2016 report on teen consumerist emotions by Piper Jaffray bank.
                    </span>
                </section>
            </div>
            <div class="item col-s-sm-12 col-xs-sm-12 col-sm-4 col-md-4 col-lg-4">
                <section>
                    ...
                    <span class="text-uppercase">
                        US teens intend their next phone to be an iPhone. It seems that youngsters just cannot get enough of the iPhone.
                    </span>
                </section>
            </div>
            <div class="item col-s-sm-12 col-xs-sm-12 col-sm-4 col-md-4 col-lg-4">
                <section>
                    ...
                    <span class="text-uppercase">
                        parents are worried about their children being kidnapped. But only 36% families track kids’ phones via various resources.
                    </span>
                </section>
            </div>
...
{Content 
    ...
    <ul class="list-images">
        ...
        <li><img src="{$img}/list/iphone-location-tracking_icon2.png" title="Routes history" alt="View full routes and locations history" class="lc-2" /><p><strong>Routes history.</strong></p>
		<p>The app pinpoints the location of a device over a certain time for visual representation of a child’s route and visited landmarks. This feature is as well available for non-jailbroken Apple devices.</p></li>
        <li><img src="{$img}/list/iphone-location-tracking_icon3.png" title="Setting geo-fences" alt="Set geofences and receive alerts" class="lc-3" /><p><strong>Setting geo-fences.</strong></p>
		<p>Geo-fencing puts a lot of worries to rest. With this helpful option, a parent is enabled to set a safe zone or a dangerous community boundaries on the map. Thus, whenever a kid leaves or enters the pre-set boundaries, Pumpic sends an alert to the parent so that he can take measures if needed.</p></li>
    </ul>
	<p>iPhone GPS tracking should be within access for every parent since iOS devices are widely spread among young ones. With the rise of mobile gadgets and GPS technologies, it had become much easier and more convenient to keep track of child’s precise whereabouts and prevent undesired situations. Eventually, by providing unmatched kids’ location monitoring features, Pumpic brings parents peace of mind.</p>
    <p>Nevertheless, it is crucial for parents to remember that over-involvement in kids’ life and a rigorous eye on them may lead to adversarial relationships. Indeed, parents are fully authorized and obliged to take care of their underage children. At the same time, before starting to monitor a child, we recommend to have a talk with your kids and notify them of your intentions. It is important to explain the security reasons for tracking so that a kid doesn’t start to rebel; on the contrary, you should show that he/she is cared for.</p>

{EndContent}

<div class="light">
        <div class="container">
                <h2 class="text-center">Monitoring from A to Z</h2>
                <div class="row">
                        <div class="col-sm-4 col-md-4 col-lg-4">
                                <div class="feature">
                                        ...
                                        <ul class="feature_list">
                                                <li>Pinpoint current location on the map</li>
                                                <li>View full routes history</li>
                                                <li>Set geofences, receive notifications</li>
                                        </ul>
                                </div>
                        </div>
                        <div class="col-sm-4 col-md-4 col-lg-4">
                                <div class="feature">
                                        ...
                                        <ul class="feature_list">
                                                ...
                                                <li>Manipulate onboard apps</li>
                                                <li>Restrict new apps installation</li>
                                        </ul>
                                </div>
                        </div>
                        <div class="col-sm-4 col-md-4 col-lg-4">
                                <div class="feature">
                                        ...
                                        <ul class="feature_list">
                                                <li>Track calls, SMS, MMS</li>
                                                <li>View online messages</li>
