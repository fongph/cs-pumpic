...
<p class="text-justify">Please note that promo subscriptions, which come in addition to a plan you purchase, are not subjects to a refund. If everything is fine with a subscription that you have bought, your order will not be refunded regardless any issues with subscriptions that you have gotten for free.</p>
									...
									<ul class="feature_list">
										<li>The target phone does not have the Internet access any longer (no money left on the balance, temporary service interruptions, roaming-related problems etc.).</li>
										<li>The mobile operator is changed by the target phone user, which leads to the loss of the Internet connectivity and consequently to the improper functioning of Pumpic.</li>
										...
										<li>No refund is issued if the Keylogger feature does not work because the target phone user uses a Keyboard different from US English.</li>
										<li>The customer has reached the limit on their subscription plan.</li>
										<li>The customer intended to monitor web activities of non-standard web-browsers, except for “Internet” (Android OS) and Safari (iOS) or Private (incognito) mode.</li>
										<li>The target phone is switched/replaced.</li>
										<li>The customer refuses to update the application or OS version after the technical issues have been resolved successfully.</li>
								...
								<div class="row_top_border">
									...
									<article>
										...
										<p class="text-justify">
											Our service may collect personally identifiable information from users in different ways, including, but not limited to, when users visit this Site, register, place an order, submit payments, subscribe to the newsletter, respond to a survey, fill out a form, and in connection with other activities, services, features or resources we make available on this Site. All users may be requested for as appropriate name, email, mailing address, phone number, credit card information as well as social security number. Users may also visit our Site anonymously. We will collect personally identifiable information only if Users voluntarily submit such information to us. Users can always refuse to supply personally identifiable data, except cases when they are engaged in certain Site-related activities.
										</p>
									</article>
								</div>
								<div class="row_top_border">
