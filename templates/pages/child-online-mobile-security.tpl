...
{include file='../includes/main/main-header.tpl'
    ...
    description="How to protect kids from online predators, cyberbullies, 18+ content, and identity theft? Pumpic reviewed and handpicked the best mobile phone safety practices."
    metaTags="true"
}    
                ...
                <ul class="no-left-padding">
                    <li style="display: list-item;">
                        <div id="infographic" class="text-center">
                            ...
                            <div class="col-md-8 col-md-offset-2">
                                <ul class="share_list share_list-infographic">
                                    ...
                                    <li><a class="share-pinterest" href="#" data-location="https://pinterest.com/pin/create/link/?url=" data-media="{$schema}{$domain}/images/infographic/v2.png"></a></li>
                                </ul>
                        ...
                        <div class="text-center">
                            ...
                            <textarea class="copy-this" style="margin: 0px; height: 200px; overflow-y: scroll;" readonly="readonly"><img src="{$schema}{$domain}/images/infographic/v2.png" width="720" height="6977" alt="How to Keep Your Kids Safe on a Smartphone" />
<p><a href="{$schema}{$domain}/child-online-mobile-security.html">How to Keep Your Kids Safe on a Smartphone [Infographic] by the team at Pumpic.</a></p></textarea>
