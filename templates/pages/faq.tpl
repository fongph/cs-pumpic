        ...
        *}
		...
		<divv class="very_easy">
			<div class="container">
             ...
             <p>Check <a class="text-link a-default" target="_blank" href="http://pumpic.dev/mobile-monitoring-control-panel-comparison.html"> detailed features comparison here.</a> </p>
                                                                                                    </div>    
                                                                                                </div>
                                                                                            </div>    
											</li>
