        ...
        <div class="row">
            <ul class="thumbs">
                <div class="col-sm-12 col-md-4 clearfix">
                    <div class="thumbnail">
                        <span class="img_thumb"><img src="images/thumb_1.png" height="216" width="360" alt="{if isset($imgAlt)}{$imgAlt}{/if}"></span>
                ...
                <div class="col-sm-12 col-md-4 clearfix">
                    <div class="thumbnail">
                        <span class="img_thumb"><img src="images/thumb_2_new.png" height="206" width="172" alt="{if isset($imgAlt)}{$imgAlt}{/if}"></span>
                        <div class="caption how-to-step">
                            <h3>Set up</h3>
                ...
                <div class="col-sm-12 col-md-4 clearfix">
                    <div class="thumbnail">
                        <span class="img_thumb"><img src="images/thumb_3_new.png" height="216" width="360" alt="{if isset($imgAlt)}{$imgAlt}{/if}"></span>
                        <div class="caption how-to-step">
                            ...
                            <p>Enter your <b>Control Panel</b> to view the data from the target device. Here you can also use the entire variety of monitoring functions like blocking and setting limits etc.
                                <span class="br"></span>From now on, you can remotely view calls and text messages, track location and monitor all kinds of online activity.
                            </p>
                        </div>
                    </div>
                </div>
