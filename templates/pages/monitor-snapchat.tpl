{include file='../includes/main/main-header.tpl' 
    title="Monitor Snapchat on Android and iOS devices | Pumpic"
    description="How to monitor Snapchat? It’s easy with Pumpic – a parental control app with a wide range of features to protect your kids by knowing what they’re is up to."
}    
...
<body>
    ...
    <!-- CONTENT -->
         {include file='../includes/content/info/info-promo.tpl'
            imgUrl = "header_banners/monitor-snapchat_header.png"
            imgAlt = "Monitor Snapchat"
            imgAlign = "right"
