...
<div class="wrapper {*bg_bottom_images*} block-child-location-tracking home-page">
    ...
    *}
    ...
    description = "What is the difference between a spy app for Android and parental controls?<br />Note: spying is illegal! Use reliable and lawful mobile monitoring apps."
