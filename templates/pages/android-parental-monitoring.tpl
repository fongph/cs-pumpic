...
{Content 
    ...
    <ul class="list-images">
        ...
        <li><img src="{$img}/list/lc_2.png" alt="Cyberbullying" class="lc-2" /><strong>Cyberbullies.</strong> Talk to your kids and find out if someone offends them. They might receive text messages with threats or bad words. Cyberbullying images can be posted anonymously in social networks and spread quickly through the Internet. More often than not, it is hard to find the source of cyberbullying, since online an offender can be not even a real person.  <a class="a-default" target="_blank" href="/parental-control-apps-android-2.3-vs-4.html">Parental control apps for Android</a> will allow you to track your kids’ online activity, follow social media, networks, as well as text messages they receive. Such software will let you find out if any threat exists, and take action before it’s too late.</li>
