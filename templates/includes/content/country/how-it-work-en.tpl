        ...
        <h2 class="text-center">How It Works</h2>
            <div class="row text-center">
                <div class="col-sm-12 col-md-4 col-lg-4 col-xs-12">
                    ...
                    <p>
                        Purchase Pumpic <b>Premium subscription</b> for 1, 3, 6 or 12 months.
                    </p>
                    <p>
                ...
                <div class="col-sm-12 col-md-4 col-lg-4 col-xs-12">
                    ...
                    <p>
                        It will take you no longer than 5 minutes. Note that <b>jailbreak</b> and <b>physical access</b> to the target device are required before installation.
                    </p>
                </div>
                <div class="col-sm-12 col-md-4 col-lg-4 col-xs-12">
