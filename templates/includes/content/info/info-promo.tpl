    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-10 col-lg-offset-1 banner-header {if $bottom_padding_null == "yes"}bottom_padding_null{/if}">
                ...
                <table id='block-table-header' style="width: 100%;">
                    <tr>
                        ...
                        <td class='col-xs-sm-12 col-s-sm-12 col-sm-12 {if isset($colRight)}{$colRight}{else}col-md-6 col-lg-6{/if}{if $imgVerticalAlign == 'bottom'} vertical-aligh-bottom{/if}'>
