    ...
    <div id="grid-images" class="row">
        <div class="col-lg-9 col-md-9 col-sm-9">
            ...
            <div class="pt30 pb20">
				...
				<p>That’s why careful parents should better use parental time control software, monitor what kind of applications their children use, and limit or lock out any app they find inappropriate. Pumpic provides comprehensive monitoring and control over activities on kids’ smartphones and tablets.</p>
            </div>
        </div>
...
{Content
	...
	<p>It does not really matter how kind or strict you are as a parent. Kids today can get uncontrollable. This applies especially to mobile device usage. Statistics show that an average teen spends about 3 hours a day staring at the phone or tablet screen. Add here couple hours watching TV and you will get a good part of a day wasted. What can you do to change the situation and push kids' energy towards a useful direction? First of all, reconsider allowed screen time restrictions and <a class="a-default" href="/limit-internet-time.html">limit Internet time</a>.</p>
