                ...
                <ul class="row-list c-f-list">
                    <li class="col-md-3 col-lg-3 padding-null">
                        <div id="c-f-block-info">
                            ...
                            <p>Monitor text content of <b>SMS</b>, <b>MMS</b>, and <b>iMessages</b> sent or received.</p>
                    ...
                    <li class="col-md-3 col-lg-3 padding-null">
                        <div id="c-f-block-info">
                            ...
                            <p>Follow <b>websites visited</b> on the target device.</p>
                    ...
                    <li class="col-md-3 col-lg-3 padding-null">
                        <div id="c-f-block-info">
                            ...
                            <p>View camera <b>shots</b> and downloaded <b>photos</b>.</p>
                    ...
                    <li class="col-md-3 col-lg-3 padding-null">
                        <div id="c-f-block-info">
                            ...
                            <p>Track the <b>exact location</b> on the map.</p>
                ...
                <ul class="row-list c-f-list">
                    <li class="col-md-3 col-lg-3 padding-null">
                        <div id="c-f-block-info">
                            ...
                            <p>Follow logs of <b>incoming</b> and <b>outgoing calls</b>.</p>
                    ...
                    <li class="col-md-3 col-lg-3 padding-null">
                        <div id="c-f-block-info">
                            ...
                            <p>Monitor personal and group <b>messages</b>, and <b>calls</b>.</p>
                    ...
                    <li class="col-md-3 col-lg-3 padding-null">
                        <div id="c-f-block-info">
                            ...
                            <p>Follow <b>personal</b> messages and <b>group chats</b>.</p>
                ...
                <ul class="row-list c-f-list">
                    <li class="col-md-3 col-lg-3 padding-null">
                        <div id="c-f-block-info">
                            ...
                            <p>View <b>websites</b> marked as favorite.</p>
                    ...
                    <li class="col-md-3 col-lg-3 padding-null">
                        <div id="c-f-block-info">
                            ...
                            <p>View <b>notes made</b> on the target device.</p>
