            ...
            <h2 class="h3 text-left">What Benefits iCloud Solution Over Jailbreak</h3>
                <div class="pt30 pb20">
                    ...
                    <ul class="list-images">
                        <li><img src="{$img}/landings/mark.png" alt="Check Mark" class="lc-1"  style="left: -29px;"/>you must know the iCloud login and password;</li>
                        <li><img src="{$img}/landings/mark.png" alt="Check Mark" class="lc-1"  style="left: -29px;"/>backup must be enabled on the target device.</li>
                    </ul>
                    ...
                    <ul class="list-images">
                        <li><img src="{$img}/landings/mark.png" alt="Check Mark" class="lc-1"  style="left: -29px;"/>the target device is connected to Wi-Fi;</li>
                        <li><img src="{$img}/landings/mark.png" alt="Check Mark" class="lc-1"  style="left: -29px;"/>it is connected to the power source (charging);</li>
                        <li><img src="{$img}/landings/mark.png" alt="Check Mark" class="lc-1"  style="left: -29px;"/>the screen of the target device is locked. </li>
                    </ul>
