...
// init output params
if ($_SERVER['REQUEST_URI'] == '/store-test-products-android.html') {
    $smarty->display($b_dir.'/templates/pages/store-test-products-android.tpl');
}if ($_SERVER['REQUEST_URI'] == '/store-test-products-ios.html') {
    $smarty->display($b_dir.'/templates/pages/store-test-products-ios.tpl');
} else { $smarty->display($b_dir.'/templates/pages/store-new-version.tpl');}
