                ...
                <div class="row">
                    ...
                    {*<table>
                        <thead>
                            <tr>
                                <th>
                                    <p>To protect your children and secure their happiness Pumpic provides you with large variety of monitoring 
                                        functions designed to make remote parenting safe and worriless.</p>
                                </th>
                            </tr>    
                        </thead>
                        <tbody>
                            ...
                            <tr>
                                <td>View Videos</td>
                                <td>View Photos</td>
                                <td>Control Browser</td>
                                <td>Control Applications</td>
                                <td>Control Social Networks</td>
                            </tr>
