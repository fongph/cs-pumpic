                                ...
                                <caption>
                                    <div class="filter_fe">
                                        <ul class="filter_list">
                                            ...
                                            <li id="filter-ios-jb" class="filter_item"><i
                                                        class="fa fa-unlock-alt filter_icon"
                                                        style="line-height: 1;"></i> <b>iOS</b><span
                                                        class="filter_version _version-hide-xs"> {$ver_ios_bot}
                                                    - {$ver_jailbreak_up}</span><span class="filter_version"> (jailbreak)</span>
                                    ...
                                    <div class="prod-head clearfix">
                                                ...
                                                <div class="prod-wrap">
                                                    <div class="prod-short-inf">
                                                        ...
                                                        <p class="prod-head__price">
                                                            <span>starting from </span><b>$6.99/</b><span> month</span>
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div id="prod-list-ios-jb" style="display: none;">
                                            <div class="col-sm-6 small-mobile-pd">
                                                <div class="prod-wrap">
                                                    <div class="prod-short-inf">
                                                        <div class="prod-head__img"><img src="/images/jb-pack.png"
                                                                                         alt="..."></div>
                                                        <p class="prod-head__version"><i
                                                                    class="icon-apple filter_icon"></i><b>iOS {$ver_ios_bot}
                                                                - {$ver_jailbreak_up}</b></p>
                                                        <p>
                                                            <span class="prod-head__device phone">iPhone</span>
                                                            <span class="prod-head__device tablet">iPad</span>
                                                            <span class="prod-head__device smart">iPod Touch</span>
                                            ...
                                            <div class="col-sm-6">
                                                <ul class="prod-list">
                                                    <li><span>Extended iOS devices monitoring and control options</span>
                                                    </li>
                                                    <li>
                                                        <span>Physical access and target device jailbreak are required</span>
                                                    </li>
                                                    <li><span>The app is visible but password-protected</span></li>
                                                </ul>
                                                <a href="#jb-features-h" class="a-default prod-features hidden-xs">Show
                                                    all 27 features</a>
                                            </div>
                                        </div>
                                        {*---LIST-IOS-JB---*}
                                                ...
                                                <div class="pricep">
                                                    <div class="save__2plan">
                                                        <div class="save__text label-touch">
                                                            <input type="checkbox" id="icloud-40off-main"
                                                                   data-checkboxes="get-40off">
                                                            <label for="icloud-40off-main">
                                                                <span>Save 40%</span> on the 2nd plan.
                                                        ...
                                                        <ul class="icloud-features m0">
                                                            ...
                                                            <li class="icloud-features__item">
                                                                <p class="icloud-features__name"><i class="icon-ok"></i>Text
                                                                    message history <span>(unlimited)</span></p>
                                                    ...
                                                    <div class="prod-icloud prod-2">
                                                        <div class="wrapper_pack wrapper_pack2 clearfix">
                                                            ...
                                                            <div class="wr_price_big">
                                                                ...
                                                                <div class="box-currence">
                                                                    <div class="symbol" attr-iso="usd">$</div>
                                                                    <div class="curr icloud-price-per-month">{$defaultiCloudProduct}</div>
                                                                </div>
                                                                <span>/ month</span>
                                                            </div>
                                                        </div>
                                                        <div class="list_price icloud-list_price" id="foot_h4">
                                                            <form name="price_premium_bottom" method="POST"
                                                                  action="/buy.html" class="buy-form-with-offer"
                                                                  autocomplete="off">
                                                                <div class="save__2plan save__second" style="top: 0;">
                                                                    <div class="save__text label-touch">
                                                                        <input type="checkbox" data-group="icloud"
                                                                               name="icloud-40off"
                                                                               id="icloud-40off-main"
                                                                               data-checkboxes="icloud-40off">
                                                                        <label for="icloud-40off-main">
                                                                            <span>Save 40%</span> on the 2nd plan.
                                                                            <div class="limited-time">Limited time
                                                                                offer!
                                                                            </div>
                                                                        </label>
                                                                    </div>
                                                                </div>
                                                                <input id='product_price_premium' type='hidden'
                                                                       name='price[productID]'
                                                                       value='{if isset($defaultIosiCloud)}{$defaultIosiCloud}{else}0{/if}'
                                                                       class="product_price"/>
                                                                <ul>
                                                                        ...
                                                                        <li>
                                                                            <label class="label_radio hover_label_radio {if $item.period == '12'}r_on{else}r_off{/if}">
                                                                                <input class="data-price"
                                                                                       ...
                                                                                       value="{$item.id}"
                                                                                       type="radio"{if $item.period == '12'} checked="checked"{/if} />
                                                                                <span class="sp">
                                                                            <strong>{$item.period}</strong> {if $item.period == 1}month{else}months{/if}
                                                                        </span>
                                                    ...
                                                    <div class="buy-wrapper hidden-xs">
                                                        <div class="wrapper_pack clearfix">
                                                            ...
                                                            <div class="wr_price_big">
                                                                ...
                                                                <div class="box-currence">
                                                                    <div class="symbol" attr-iso="usd">$</div>
                                                                    <div class="curr jailbreak-price-per-month">{$defaultPremiumPrice}</div>
                                                                </div>
                                                                <span>/ month</span>
                                                            </div>
                                                        </div>
                                                        <div class="list_price icloud-list_price">
                                                            ...
                                                            <form name="price_premium" method="POST" action="/buy.html"
                                                                ...
                                                                <div class="save__2plan">
                                                                    <div class="save__text label-touch">
                                                                        <input type="checkbox" name="jailbreak-40off"
                                                                               id="jailbreak-40off-main"
                                                                               data-checkboxes="jailbreak-40off">
                                                        ...
                                                        <input id='product_price_premium' type='hidden'
                                                               name='price[productID]'
                                                               value='{if isset($getDefaultIosJailbreak)}{$getDefaultiosJailbreak}{else}0{/if}'
                                                               class="product_price"/>
                                                        ...
                                                        <ul>
                                                            {foreach from=$getProducts.iosJailbreak key=key item=item}
                                                                <li>
                                                                    <label class="label_radio hover_label_radio {if $item.period == '12'}r_on{else}r_off{/if}">
                                                                        <input class="data-price"
                                                                               data-target=".jailbreak-price-per-month"
                                                                               data-cur="usd"
                                                                               data-price-usd="{$item.price}"
                                                                               data-offer-price-usd="{$getProducts.iosJailbreakDouble[$key].price}"
                                                                               data-period="{$item.period}"
                                                                               data-product="{$item.id}"
                                                                               data-offer-product="{$getProducts.iosJailbreakDouble[$key].id}"
                                                                               data-group="jailbreak"
                                                                               name="optionsRadios"
                                                                               id="optionsRadios{$item.id}1"
                                                                               value="{$item.id}"
                                                                               type="radio"{if $item.period == '12'} checked="checked"{/if} />
                                                                        ...
                                                                        <div class="package_offer_price">
                                                                            <strong>
                                                                                <div class="box-currence">
                                                                                    ...
                                                                                    <div class="curr">{$getProducts.iosJailbreakDouble[$key].price}</div>
                                                                                </div>
                                                                            </strong>
                                                                        </div>
                                                                    </label>
                                                        ...
                                                        <button class="btn btn-default ga-action-click"
                                                                ...
                                                                value="true" type="submit" name="price[submit]">Buy
                                                        </button>
                                                        </form>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="premium_fe _jailbreak-f">
                                                    ...
                                                    <ul class="icloud-features m0">
                                                        <li class="icloud-features__item">
                                                            <p class="icloud-features__name"><i class="icon-ok"></i>Calls
                                                                history</p>
                                                            <p class="icloud-features__info m0">View detailed data on
                                                                incoming/outgoing calls: name, phone number, time and
                                                                duration.</p>
                                                        </li>
                                                        <li class="icloud-features__item">
                                                            <p class="icloud-features__name"><i class="icon-ok"></i>Text
                                                                message history</p>
                                                            <p class="icloud-features__info m0">View text content sent
                                                                or received via SMS, MMS, and iMessages.</p>
                                                        </li>
                                                        <li class="icloud-features__item">
                                                            <p class="icloud-features__name"><i class="icon-ok"></i>WhatsApp
                                                            </p>
                                                            <p class="icloud-features__info m0">Track chats and calls on
                                                                WhatsApp.</p>
                                                        </li>
                                                        <li class="icloud-features__item">
                                                            <p class="icloud-features__name"><i class="icon-ok"></i>Calendar
                                                            </p>
                                                            <p class="icloud-features__info m0">Monitor scheduled dates
                                                                and events.</p>
                                                        </li>
                                                        <li class="icloud-features__item">
                                                            <p class="icloud-features__name"><i class="icon-ok"></i>Notes
                                                        ...
                                                        <li class="icloud-features__item">
                                                            ...
                                                            <p class="icloud-features__info m0">View all websites
                                                                visited and bookmarked as preferred ones.</p>
                                                        </li>
                                                        <li class="icloud-features__item">
                                                            <p class="icloud-features__name"><i class="icon-ok"></i>Browsing
                                                                history</p>
                                                        ...
                                                        <li class="icloud-features__item">
                                                            ...
                                                            <p class="icloud-features__info m0">View all photos stored
                                                                on a device.</p>
                                                        </li>
                                                        <li class="icloud-features__item">
                                                            <p class="icloud-features__name"><i class="icon-ok"></i>Skype
                                                        ...
                                                        <li class="icloud-features__item">
                                                            ...
                                                            <p class="icloud-features__info m0">Track conversations via
                                                                Kik.</p>
                                                        </li>
                                                        <li class="icloud-features__item">
                                                            <p class="icloud-features__name"><i class="icon-ok"></i>Historical
                                                                data</p>
                                                            <p class="icloud-features__info m0">View all the previous
                                                                data ever stored on a device.</p>
                                                        </li>
                                                        <li class="icloud-features__item">
                                                            <p class="icloud-features__name"><i class="icon-ok"></i>Location
                                                                history</p>
                                                            <p class="icloud-features__info m0">Track current location
                                                                as well as the entire route history. Map view
                                                                available.</p>
                                                        </li>
                                                        <li class="icloud-features__item">
                                                            <p class="icloud-features__name"><i class="icon-ok"></i>Contacts
                                                        ...
                                                        <li class="icloud-features__item">
                                                            <p class="icloud-features__name"><i class="icon-ok"></i>Calls
                                                                blocking</p>
                                                            <p class="icloud-features__info m0">Block calls from
                                                                specific numbers.</p>
                                                        </li>
                                                        <li class="icloud-features__item">
                                                            <p class="icloud-features__name"><i class="icon-ok"></i>SMS
                                                                blocking</p>
                                                            <p class="icloud-features__info m0">Block SMS from specific
                                                                senders and/or containing specific keywords.</p>
                                                        </li>
                                                        <li class="icloud-features__item">
                                                            <p class="icloud-features__name"><i class="icon-ok"></i>SMS
                                                                limiting</p>
                                                            <p class="icloud-features__info m0">Set a number of SMS a
                                                                user can send daily.</p>
                                                        </li>
                                                        <li class="icloud-features__item">
                                                            <p class="icloud-features__name"><i class="icon-ok"></i>
                                                                Geo-fences</p>
                                                            <p class="icloud-features__info m0">Set specific zones and
                                                                receive alerts once the target device leaves them or
                                                                enters.</p>
                                                        </li>
                                                        <li class="icloud-features__item">
                                                            <p class="icloud-features__name"><i class="icon-ok"></i>
                                                                Websites blocking</p>
                                                            <p class="icloud-features__info m0">Block specific websites
                                                                on a target device.</p>
                                                        </li>
                                                        <li class="icloud-features__item">
                                                            <p class="icloud-features__name"><i class="icon-ok"></i>
                                                                Emails</p>
                                                            <p class="icloud-features__info m0">View all emails and
                                                                detailed contact data.</p>
                                                        </li>
                                                        <li class="icloud-features__item">
                                                            <p class="icloud-features__name"><i class="icon-ok"></i>
                                                                Applications Management</p>
                                                            <p class="icloud-features__info m0">Monitor, block or set
                                                                time limits on all applications (games, services etc.)
                                                                downloaded on a device.</p>
                                                        </li>
                                                        <li class="icloud-features__item">
                                                            <p class="icloud-features__name"><i class="icon-ok"></i>
                                                                Videos</p>
                                                            <p class="icloud-features__info m0">View all videos stored
                                                                on a device.</p>
                                                        </li>
                                                        <li class="icloud-features__item">
                                                            <p class="icloud-features__name"><i class="icon-ok"></i>Viber
                                                            </p>
                                                            <p class="icloud-features__info m0">Track chats and calls on
                                                                Viber.</p>
                                                        </li>
                                                        <li class="icloud-features__item">
                                                            <p class="icloud-features__name"><i class="icon-ok"></i>
                                                                Instagram</p>
                                                            <p class="icloud-features__info m0">Monitor posted images
                                                                and comments on Instagram.</p>
                                                        </li>
                                                        <li class="icloud-features__item">
                                                            <p class="icloud-features__name"><i class="icon-ok"></i>
                                                                Snapchat</p>
                                                            <p class="icloud-features__info m0">Monitor Snapchat chat
                                                                messages.</p>
                                                        </li>
                                                        <li class="icloud-features__item">
                                                            <p class="icloud-features__name"><i class="icon-ok"></i>
                                                        ...
                                                        <li class="icloud-features__item">
                                                            <p class="icloud-features__name"><i class="icon-ok"></i> SMS
                                                                commands</p>
                                                            <p class="icloud-features__info m0">Control devices
                                                                remotely.</p>
                                                        </li>
                                                        <li class="icloud-features__item">
                                                            <p class="icloud-features__name"><i class="icon-ok"></i>
                                                                Keylogger</p>
                                                            <p class="icloud-features__info m0">View every keystroke
                                                                typed on a target device.</p>
                                                        </li>
                                                    </ul>
                                                    <div class="table_title free-label">
                                                        <h3 class="free-label__headname">FREE:</h3>
                                                        ...
                                                        <form name="price_premium" method="POST" action="/buy.html"
                                                            ...
                                                            <div class="save__2plan">
                                                                <div class="save__text label-touch">
                                                                    ...
                                                                    <label for="jailbreak-40off-main">
                                                                        <span>Save 40%</span> on the 2nd plan.
                                                                        <div class="limited-time">Limited time offer!
                                                                        </div>
                                                                    </label>
                                                                </div>
                                                            </div>
