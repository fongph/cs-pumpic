            ...
            <div class="item col-s-sm-12 col-xs-sm-12 col-sm-4 col-md-4 col-lg-4">
                <section>
                    ...
                    <span class="text-uppercase">
                        parents do worry about what their kids can be exposed to while browsing the Internet. But there is a huge difference between worrying and taking particular steps to protect children from online risks.
                    </span>
                </section>
            </div>
            <div class="item col-s-sm-12 col-xs-sm-12 col-sm-4 col-md-4 col-lg-4">
                <section>
                    ...
                    <span class="text-uppercase">
                        kids visited a website their parents would disapprove of. Typically, parents remain clueless of such cases relying on children’s ratio. However, forbidden fruit often turns out to be much sweeter than rational arguments.
                    </span>
                </section>
            </div>
            <div class="item col-s-sm-12 col-xs-sm-12 col-sm-4 col-md-4 col-lg-4">
                <section>
                    <div><strong class="fz50 color-orange">22%</strong></div>
                    <span class="text-uppercase">
        ...
        <table class="table-statistick">
            <tr>
                <td class="item col-s-sm-12 col-xs-sm-12 col-sm-12 col-md-4 col-lg-4 border-none">
                    <section>
                        <div class='pb20'><strong class="fz50 color-orange">Separate Internet Filter</strong></div>
                        <p>Usually, Internet filtering tool can “clean up” the Internet for kids by restricting access to the websites with explicit material. Often based on the child’s age presets, it automatically blocks porn sites, allows keyword filtering as well as adding specific web pages to the blacklist. Some of them are able to mask obscene language instead of blocking the whole page. Another approach is to create a list of trusted websites and let user visit pages only from this whitelist. That’s basically all that Internet filters can do.</p>
                    </section>
                </td>
                ...
                <td class="item col-s-sm-12 col-xs-sm-12 col-sm-12 col-md-4 col-lg-4 border-none">
                    <section>
                        ...
                        <p>In its turn, comprehensive parental control mobile software is a wider concept that usually includes online content filtering. It also can log all browsing history and track IM texting. However, its functionality reaches far beyond just filtering inappropriate content. Call and SMS tracking, multimedia monitoring, GPS tracking and keylogging – you can do all of that with designated app. Naturally, such functions will be highly demanded by parents who want to protect their children not only from digital but also from real-world dangers.</p>
                    </section>
                </td>
            </tr>
        </table>
                ...
                <div class="row">
                        <div class="col-sm-4 col-md-4 col-lg-4">
                                <div class="feature">
                                        ...
                                        <ul class="feature_list">
                                                <li>Block websites and pages</li>
                        ...
                        <div class="col-sm-4 col-md-4 col-lg-4">
                                <div class="feature">
                                        ...
                                        <ul class="feature_list">
                                                <li>View call logs, SMS, MMS, multimedia</li>
                        ...
                        <div class="col-sm-4 col-md-4 col-lg-4">
                                <div class="feature">
                                        ...
                                        <ul class="feature_list">
                                                <li>Check location in real time</li>
