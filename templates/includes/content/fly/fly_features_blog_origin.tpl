...
<div class="fly-features-v2 fly-features-v1">
    <div id="fly_features">
        ...
        <div id="fly_top">
            <h2 id="fly-features-h2">iCloud Monitoring<div class="br"></div>for iOS <img src="/images/fly_features/ios11-icon.svg" width="20" height="20" alt=""><div class="br"></div>Without Jailbreak</h2>
            <p class="fly-label"></p>
