                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-10 col-md-10 col-lg-offset-1 col-md-offset-1">
                                    <table class="tb_pricing table-bordered pricing-second">
                                        ...
                                        <div class="support_new_os"><div class="wr_support_new_os"><i class="icon-android d_green"></i> Android 2.2 - 5.1 <i class="icon-apple d_green"></i> iOS 6.0 - 8.4.1</div></div>
                                        </caption>
                                        <thead>
                                            <tr>
                                                <th>
                                                        ...
                                                        <div class="pricep">
                                                           ...
                                                           <div class="premium_fe">
                                                            <ul>
                                                                ...
                                                                <li data-toggle="tooltip" data-placement="top" title="Track conversations via Skype, WhatsApp, Viber, and Kik. Monitor Skype and WhatsApp calls.<div class='br'><strong>iOS: Jailbreak Needed</strong><br /><strong>Android: Root Required</strong></div>"><i class="icon-ok"></i> Viber/WhatsApp/Skype/Kik</li>
