...
{Content
    ...
    <div id="grid-images" class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
			...
			<p>To perform <a class="a-default" href="/tracking-app-for-iphone.html">iPhone tracking</a> of your kid’s device through iCloud the following requirements must be satisfied:</p>
