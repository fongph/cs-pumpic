                                ...
                                <div class="notice">
                                    <h2 class="notice-title">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="22px" height="22px">
                                            <path fill-rule="evenodd"  fill="rgb(255, 255, 255)" d="M11.000,1.000 C16.523,1.000 21.000,5.477 21.000,11.000 C21.000,16.523 16.523,21.000 11.000,21.000 C5.477,21.000 1.000,16.523 1.000,11.000 C1.000,5.477 5.477,1.000 11.000,1.000 Z"/>
                    ...
                    <div class="col-lg-10 col-lg-offset-1">
                        ...
                        <div class="row text-center">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <p class="text-justify">If you have any questions or suggestions, which will help improve our services, please feel free to contact us using the form below.</p>
