<form action="/contact_us_send.html" class="form-contact-us" name="send-mail-contact-us" method="POST">
        <fieldset>
                ...
                <div class="col-lg-6 col-lg-offset-3 col-md-6 col-md-offset-3">
                        ...
                        <p>Learn more from our <a class="go_block_scroll" href="#faq_frequently_asked_questions">FAQ</a> before submitting your question.{*before submitting an application.*}</p>
