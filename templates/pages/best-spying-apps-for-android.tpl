    ...
    <div id="grid-images" class="row">
        <div class="col-lg-9 col-md-9 col-sm-9">
            ...
            <div class="pt30 pb20">
				...
				<li><img src="/images/landings/check-icon.png" alt="Check Mark" class="lc-1" style="left: -29px;"/>It is easy to use – install the tracking app in a matter of minutes and monitor your teen from any browser and any device.</li>
